...
def reservation():
    rooms = helper.find_reservation(request)
    return render_template("app/reservation.html", rooms=rooms)
...
def basket_clear():
    basket = {'basket','id','title','amenities','price','kapasitas'}
...
# @app.route("/admin/reservation/update")
# def update_reservation():
#     roles = helper.session_get('user_roles')
#     if (roles != "admin"):
#         return index()
#     reservation = helper.update_reservation(request)
#     return a_reservation()
#     return render_template("admin/update.html", data=reservation)
